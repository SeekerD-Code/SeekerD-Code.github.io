        ...
        if (articolo) {
            document.getElementById('content-container').innerHTML = `
                ...
                <div class="cta-festmap" style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin: 20px 0;">
                    <p>${articolo.cta}</p>
                    <a href="${articolo.linkFestMap}" target="_blank" style="display: inline-block; font-weight: bold; color: #0066cc; text-decoration: underline;">Vai alla Home di FestMap</a>
                </div>
